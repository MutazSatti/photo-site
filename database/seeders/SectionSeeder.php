...
class SectionSeeder extends Seeder
{
    ...
    private function seedServiceCategories(): void
    {
        ...
        /*
         * النصّ يُكتب عند الإنشاء فقط.
         *
         * الاسم والوصف يُحرَّران من لوحة التحكم، وبذرةٌ تُشغَّل بعد كل نشر كانت
         * تعيدهما إلى ما في هذا الملف — فيكتشف المالك أن تعديله ذهب بلا سبب
         * ظاهر. وتغيير النصّ المنشور مكانه هجرة محتوى تجري مرّة واحدة.
         */
        foreach ($categories as $data) {
            $keys = ['section_id' => $section->id, 'slug' => $data['slug']];

            if (Category::where($keys)->exists()) {
                continue;
            }

            Category::create($data + ['section_id' => $section->id]);
        }
    }
}
