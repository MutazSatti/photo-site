...
new #[Layout('layouts::admin', ['title' => 'صور الواجهة'])] class extends Component
{
    ...
    public function groups(): array
    {
        return array_values(array_filter([
            ...
            [
                'title' => 'صفحة الزواجات والمناسبات',
                'description' => 'صورة الواجهة خلف عنوان الصفحة. تُعرض بعرض الصفحة وتحتها تدرّج داكن، فاللقطة الليلية أنسبها.',
                'kind' => 'cover',
                'slots' => $this->fixedSlots([
                    'ev_hero' => ['صورة الواجهة', 'أقوى لقطة في الملف — تُعرض بعرض الصفحة'],
                ]),
            ],
            [
