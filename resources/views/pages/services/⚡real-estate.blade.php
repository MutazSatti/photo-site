...
new class extends Component
{
    ...
    /**
     * زوج المقارنة: اللقطة الخام ومعالَجتها.
     *
        ...
        @if ($this->comparison)
            ...
            >
                <h2 id="compare-heading" class="text-xl font-extrabold text-ink-900 sm:text-2xl dark:text-ink-50">
                    اللقطة نفسها، قبل المعالجة وبعدها
                </h2>
                <p class="max-w-2xl mt-2 text-sm leading-8 text-ink-600 dark:text-ink-400">
                    اسحب المقبض لترى الفرق. الملفّان حقيقيان من الأرشيف: الخام كما خرج من الكاميرا، والمعالَج كما يُسلَّم.
                </p>
                ...
                {{--
                    ...
                    والصورة الخام تُمدّ بارتفاع الحاوية لا بعرض ثابت: اللقطتان
                    نفسهما بنسبة أبعاد واحدة، فمطابقة الارتفاع تطابق العرض حتمًا،
                    وتبقى المطابقة قائمة مهما تغيّر عرض الشاشة.
                --}}
                <div
                ...
                >
                    ...
                    <div class="absolute inset-y-0 start-0 overflow-hidden" x-bind:style="`width: ${split}%`">
                        <x-site.picture
                            ...
                            variant="lg"
                            sizes="100vw"
                            class="absolute inset-y-0 start-0 h-full w-auto max-w-none"
                        />
                    </div>
