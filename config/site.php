...
return [
    ...
    */
    /*
     * نطاق الخدمة يُحرَّر من لوحة التحكم (الإعدادات ← التواصل ← نطاق الخدمة).
     * وما هنا شبكة أمان تُستعمل قبل تشغيل البذور أو إن فُرّغ الحقل، فتبقى
     * مدينة المصوّر وحدها — إضافةُ مدنٍ هنا تعِد بما لم يقرّره المالك.
     */
    'service_areas' => [
        env('SITE_CITY', 'جدة'),
    ],
